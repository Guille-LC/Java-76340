...
CREATE TABLE `cliente_coche` (
  ...
  KEY `FK41rsmf75w0uv51hvk38khv1yh` (`cliente_id`),
  KEY `FK936fgfvqk3rk7b0852hpqhsqc` (`coche_id`),
  CONSTRAINT `FK41rsmf75w0uv51hvk38khv1yh` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `FK936fgfvqk3rk7b0852hpqhsqc` FOREIGN KEY (`coche_id`) REFERENCES `coches` (`id`)
